...
from monitoring_provisioner.domain.log_agent.log_collector import (
    LogInputType, LogCollectorConfigContext,
    JsonFieldMapping, FilterCondition, FilterOperator
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        json_ctx = LogCollectorConfigContext(
            ...
            # 조건 필터
            filters=[
                FilterCondition(field="user.age", operator=FilterOperator.NOT_EQUALS, value="30")
            ]
        )

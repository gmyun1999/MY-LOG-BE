# Generated by Django 5.0.6 on 2025-04-30 08:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'User',
                'indexes': [models.Index(fields=['name'], name='User_name_ad0720_idx'), models.Index(fields=['created_at'], name='User_created_2c9361_idx'), models.Index(fields=['updated_at'], name='User_updated_085f8b_idx')],
